...
AWS_CRT_API const char *aws_crt_credentials_provider_static_options_get_access_key_id(
    struct aws_crt_credentials_provider_static_options *options);
...
AWS_CRT_API struct aws_crt_credentials_provider *aws_crt_credentials_provider_static_new(
    struct aws_crt_credentials_provider_static_options *options);
...
AWS_CRT_API void aws_crt_credentials_provider_environment_options_release(
    struct aws_crt_credentials_provider_environment_options *options);

AWS_CRT_API struct aws_crt_credentials_provider *aws_crt_credentials_provider_environment_new(
    struct aws_crt_credentials_provider_environment_options *options);
...
AWS_CRT_API aws_credentials_provider_cached_options *aws_crt_credentials_provider_cached_options_new(void);
...
typedef struct aws_credentials_provider_imds_options aws_crt_credentials_provider_options;
...
AWS_CRT_API void aws_crt_credentials_provider_imds_options_set_imds_version(
    aws_credetnials_provider_imds_options *options,
    int imds_version);
...
AWS_CRT_API aws_credentials_provider_ecs_options *aws_crt_credentials_provider_ecs_options_new(void);
...
AWS_CRT_API aws_crt_credentials_provider *aws_crt_credentials_provider_ecs_new(
    struct aws_crt_credentials_provider_ecs_options *options);
...
AWS_CRT_API void aws_crt_credentials_provider_x509_options_set_role_alias(
    aws_credetnials_provider_x509_options *options,
    uint8_t *role_alias,
...
AWS_CRT_API void aws_crt_signing_config_aws_set_signature_type(
    ...
    int sig_type);
AWS_CRT_API struct aws_crt_credentials_provider *aws_crt_signing_config_aws_get_credentials_provider(
    struct aws_signing_config_aws *signing_config);
...
typedef void(aws_crt_complete_signing_fn)(aws_crt_signing_result *result, int error_code, void *user_data);
