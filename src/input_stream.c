...
typedef struct _aws_crt_input_stream_options {
    void *user_data;
...
struct aws_crt_input_stream *aws_crt_input_stream_new(aws_crt_input_stream_options *options) {
