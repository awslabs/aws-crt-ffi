...
pub const _aws_crt_log_level_AWS_CRT_LOG_NONE: _aws_crt_log_level = _aws_crt_log_level(0);
pub const _aws_crt_log_level_AWS_CRT_LOG_FATAL: _aws_crt_log_level = _aws_crt_log_level(1);
pub const _aws_crt_log_level_AWS_CRT_LOG_ERROR: _aws_crt_log_level = _aws_crt_log_level(2);
pub const _aws_crt_log_level_AWS_CRT_LOG_WARN: _aws_crt_log_level = _aws_crt_log_level(3);
pub const _aws_crt_log_level_AWS_CRT_LOG_INFO: _aws_crt_log_level = _aws_crt_log_level(4);
pub const _aws_crt_log_level_AWS_CRT_LOG_DEBUG: _aws_crt_log_level = _aws_crt_log_level(5);
pub const _aws_crt_log_level_AWS_CRT_LOG_TRACE: _aws_crt_log_level = _aws_crt_log_level(6);
#[repr(transparent)]
...
const _: () = {
    ["Size of _aws_crt_input_stream_status"]
        [::std::mem::size_of::<_aws_crt_input_stream_status>() - 2usize];
    ["Alignment of _aws_crt_input_stream_status"]
        [::std::mem::align_of::<_aws_crt_input_stream_status>() - 1usize];
    ["Offset of field: _aws_crt_input_stream_status::is_end_of_stream"]
        [::std::mem::offset_of!(_aws_crt_input_stream_status, is_end_of_stream) - 0usize];
    ["Offset of field: _aws_crt_input_stream_status::is_valid"]
        [::std::mem::offset_of!(_aws_crt_input_stream_status, is_valid) - 1usize];
};
...
pub const aws_crt_input_stream_seek_basis_AWS_CRT_STREAM_SEEK_BASIS_BEGIN:
    aws_crt_input_stream_seek_basis = aws_crt_input_stream_seek_basis(0);
pub const aws_crt_input_stream_seek_basis_AWS_CRT_STREAM_SEEK_BASIS_END:
    aws_crt_input_stream_seek_basis = aws_crt_input_stream_seek_basis(2);
#[repr(transparent)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of aws_crt_buf"][::std::mem::size_of::<aws_crt_buf>() - 16usize];
    ["Alignment of aws_crt_buf"][::std::mem::align_of::<aws_crt_buf>() - 8usize];
    ["Offset of field: aws_crt_buf::blob"][::std::mem::offset_of!(aws_crt_buf, blob) - 0usize];
    ["Offset of field: aws_crt_buf::length"][::std::mem::offset_of!(aws_crt_buf, length) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const aws_crt_imds_protocol_version_AWS_CRT_IMDS_PROTOCOL_V2: aws_crt_imds_protocol_version =
    aws_crt_imds_protocol_version(0);
pub const aws_crt_imds_protocol_version_AWS_CRT_IMDS_PROTOCOL_V1: aws_crt_imds_protocol_version =
...
pub const aws_crt_signing_algorithm_AWS_CRT_SIGNING_ALGORITHM_V4: aws_crt_signing_algorithm =
    aws_crt_signing_algorithm(0);
pub const aws_crt_signing_algorithm_AWS_CRT_SIGNING_ALGORITHM_V4_ASYMMETRIC:
    aws_crt_signing_algorithm = aws_crt_signing_algorithm(1);
pub const aws_crt_signing_algorithm_AWS_CRT_SIGNING_ALGORITHM_V4_S3EXPRESS:
    aws_crt_signing_algorithm = aws_crt_signing_algorithm(2);
#[repr(transparent)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
pub const aws_crt_signature_type_AWS_CRT_SIGNATURE_TYPE_HTTP_REQUEST_HEADERS:
    aws_crt_signature_type = aws_crt_signature_type(0);
pub const aws_crt_signature_type_AWS_CRT_SIGNATURE_TYPE_HTTP_REQUEST_QUERY_PARAMS:
    aws_crt_signature_type = aws_crt_signature_type(1);
...
pub const aws_crt_signature_type_AWS_CRT_SIGNATURE_TYPE_CANONICAL_REQUEST_HEADERS:
    aws_crt_signature_type = aws_crt_signature_type(4);
pub const aws_crt_signature_type_AWS_CRT_SIGNATURE_TYPE_CANONICAL_REQUEST_QUERY_PARAMS:
    aws_crt_signature_type = aws_crt_signature_type(5);
#[repr(transparent)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
pub const aws_crt_signed_body_header_type_AWS_CRT_SIGNED_BODY_HEADER_TYPE_NONE:
    aws_crt_signed_body_header_type = aws_crt_signed_body_header_type(0);
